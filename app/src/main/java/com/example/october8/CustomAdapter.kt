    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        when(ViewList[position]) {
            ...
            IMAGE_RECYCLER_VIEW -> {
                ...
                viewHolderImage.imageViewcard.setImageResource(R.drawable.noodles)
            }
            TEXT_IMAGE_RECYCLER_VIEW -> {
                val viewHolderImage = holder as ViewHolderImageText
                viewHolderImage.cardImageView.setImageResource(R.drawable.chinese)
